...
<head>
    ...
    def _footer_block(self) -> str:
        return """
        <footer>
            <div>Generated by <span style="color:var(--text-dim);font-weight:700;">telmus v0.1.8</span> | <code>pip install telmus</code></div>
        ...
        <header>
            ...
            <div style="text-align:right;">
                <span class="font-mono" style="font-size:1.375rem;font-weight:800;color:#fff;">
                    <span style="color:var(--teal);">telmus</span> v0.1.8
                </span>
            </div>
        </header>
