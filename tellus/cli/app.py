...
from tellus.mcp.server import run_mcp_server

app = typer.Typer(help="tellus financial statement analysis CLI")
console = Console()
...
def info() -> None:
    """Print package info."""
    try:
        package_version = version("tellus")
    except Exception:
